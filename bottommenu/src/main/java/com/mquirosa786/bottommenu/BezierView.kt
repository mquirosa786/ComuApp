...
class BezierView : View {
    ...
    var progress = 0f
        set(value) {
            ...
            progressArray[0].x = 0f
            progressArray[1].x = bezierX - bezierInnerWidth / 1.45f
            progressArray[2].x = bezierX - bezierInnerWidth / 4.45f
            progressArray[3].x = bezierX - bezierInnerWidth / 2f
            progressArray[4].x = bezierX
            progressArray[5].x = bezierX + bezierInnerWidth / 2f
            progressArray[6].x = bezierX + bezierInnerWidth / 4.45f
            progressArray[7].x = bezierX + bezierInnerWidth / 1.45f
            progressArray[8].x = width
            for (i in 2..6) {
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        bezierOuterWidth = dipf(context, 100)
        bezierOuterHeight = dipf(context, 2)
        bezierInnerWidth = dipf(context, 78)//MQ 80
        bezierInnerHeight = dipf(context, 20)
        val extra = shadowHeight
        var extraBottom = (height*30/64)-20//distance between clicked icon and line below MQ --30
        outerArray[0] = PointF(0f, bezierInnerHeight + extra)
        outerArray[1] = PointF((bezierX - bezierInnerWidth / 1.45f), bezierInnerHeight + extra)//1.45
        outerArray[2] = PointF(bezierX - bezierInnerWidth / 4.45f, bezierInnerHeight + extra+15)//4.45
        outerArray[3] = PointF(bezierX - bezierInnerWidth / 6f, height - extraBottom)//2
        outerArray[4] = PointF(bezierX, height - extraBottom+0.9f)//0.9
        outerArray[5] = PointF(bezierX + bezierInnerWidth / 6f, height - extraBottom)//2
        outerArray[6] = PointF(bezierX + bezierInnerWidth / 4.45f, bezierInnerHeight + extra+15)//4.45
        outerArray[7] = PointF(bezierX + bezierInnerWidth / 1.45f, bezierInnerHeight + extra)//1.45
        outerArray[8] = PointF(width, bezierInnerHeight + extra)
    ...
    private fun calculateInner() {
        ...
        innerArray[1] = PointF((bezierX - bezierInnerWidth / 1.45f), bezierInnerHeight + extra)//1.45
        innerArray[2] = PointF(bezierX - bezierInnerWidth / 4.45f, bezierInnerHeight + extra+15)//4.45
        innerArray[3] = PointF(bezierX - bezierInnerWidth / 2f, height - extraBottom)//2
        innerArray[4] = PointF(bezierX, height - extraBottom+0.9f)//0.9
        innerArray[5] = PointF(bezierX + bezierInnerWidth / 2f, height - extraBottom)//2
        innerArray[6] = PointF(bezierX + bezierInnerWidth / 4.45f, bezierInnerHeight + extra+15)//4.45
        innerArray[7] = PointF(bezierX + bezierInnerWidth / 1.45f, bezierInnerHeight + extra)//1.45
